...
+ (void)drawCameraShutterWithFrame: (CGRect)frame
{
    ...
    //// Color Declarations
    UIColor* color0 = [UIColor colorWithRed: 0.98 green: 0.67 blue: 0.8 alpha: 1];
    UIColor* color1 = [UIColor colorWithRed: 0.98 green: 0.67 blue: 0.8 alpha: 1];
...
+ (void)drawCameraFlashWithFrame: (CGRect)frame
{
    ...
    //// Color Declarations
    UIColor* color = [UIColor colorWithRed: 0.98 green: 0.67 blue: 0.8 alpha: 1];
...
+ (void)drawCameraToggleWithFrame: (CGRect)frame
{
    ...
    //// Color Declarations
    UIColor* color2 = [UIColor colorWithRed: 0.98 green: 0.67 blue: 0.8 alpha: 1];
...
+ (void)drawCameraDismissWithFrame: (CGRect)frame
{
    ...
    //// Color Declarations
    UIColor* color3 = [UIColor colorWithRed: 0.98 green: 0.67 blue: 0.8 alpha: 1];
